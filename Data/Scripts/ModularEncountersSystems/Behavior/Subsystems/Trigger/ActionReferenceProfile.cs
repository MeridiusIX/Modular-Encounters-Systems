...
namespace ModularEncountersSystems.Behavior.Subsystems.Trigger {
	...
	public class ActionReferenceProfile {
		...
		EditorReference = new Dictionary<string, Action<string, object>> {
                ...
                {"GridEditable", (s, o) => TagParse.TagCheckEnumCheck(s, ref GridEditable, ProfileSubtypeId) },
                {"SubGridsEditable", (s, o) => TagParse.TagCheckEnumCheck(s, ref SubGridsEditable, ProfileSubtypeId) },
                {"GridDestructible", (s, o) => TagParse.TagCheckEnumCheck(s, ref GridDestructible, ProfileSubtypeId) },
                {"SubGridsDestructible", (s, o) => TagParse.TagCheckEnumCheck(s, ref SubGridsDestructible, ProfileSubtypeId) },
