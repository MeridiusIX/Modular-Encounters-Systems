...
| Description:                                                                                                                                                                                   | This tag determines the height offset from the planet surface if a`Direction` tag is provided.<br />Use the `/MES.Info.GetLocationMatrix` chat command to get the height offset at your current player position. |
...
| Description:                                                                                                                                                                                   | This tag determines if only a list of specific SpawnGroups should only be allowed to spawn in this Zone. |
| Allowed Values:                                                                                                                                                                                | `truefalse`                                                                                            |
| Default Value(s):                                                                                                                                                                              | `false`                                                                                                |
| Multiple Tag Allowed:                                                                                                                                                                          | No                                                                                                       |
